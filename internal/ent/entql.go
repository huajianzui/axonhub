...
func (f *ChannelFilter) WhereHasAccounts() {
...
func (f *ChannelFilter) WhereHasAccountsWith(preds ...predicate.ChannelAccount) {
...
// addPredicate implements the predicateAdder interface.
func (_q *ChannelAccountQuery) addPredicate(pred func(s *sql.Selector)) {
	_q.predicates = append(_q.predicates, pred)
}

// Filter returns a Filter implementation to apply filters on the ChannelAccountQuery builder.
func (_q *ChannelAccountQuery) Filter() *ChannelAccountFilter {
	return &ChannelAccountFilter{config: _q.config, predicateAdder: _q}
}

// addPredicate implements the predicateAdder interface.
func (m *ChannelAccountMutation) addPredicate(pred func(s *sql.Selector)) {
	m.predicates = append(m.predicates, pred)
}

// Filter returns an entql.Where implementation to apply filters on the ChannelAccountMutation builder.
func (m *ChannelAccountMutation) Filter() *ChannelAccountFilter {
	return &ChannelAccountFilter{config: m.config, predicateAdder: m}
}

// ChannelAccountFilter provides a generic filtering capability at runtime for ChannelAccountQuery.
...
// Where applies the entql predicate on the query filter.
func (f *ChannelAccountFilter) Where(p entql.P) {
	f.addPredicate(func(s *sql.Selector) {
...
// WhereID applies the entql int predicate on the id field.
func (f *ChannelAccountFilter) WhereID(p entql.IntP) {
	f.Where(p.Field(channelaccount.FieldID))
}

// WhereCreatedAt applies the entql time.Time predicate on the created_at field.
func (f *ChannelAccountFilter) WhereCreatedAt(p entql.TimeP) {
	f.Where(p.Field(channelaccount.FieldCreatedAt))
}

// WhereUpdatedAt applies the entql time.Time predicate on the updated_at field.
func (f *ChannelAccountFilter) WhereUpdatedAt(p entql.TimeP) {
	f.Where(p.Field(channelaccount.FieldUpdatedAt))
}

// WhereDeletedAt applies the entql int predicate on the deleted_at field.
func (f *ChannelAccountFilter) WhereDeletedAt(p entql.IntP) {
	f.Where(p.Field(channelaccount.FieldDeletedAt))
}

// WhereChannelID applies the entql int predicate on the channel_id field.
func (f *ChannelAccountFilter) WhereChannelID(p entql.IntP) {
	f.Where(p.Field(channelaccount.FieldChannelID))
}

// WhereName applies the entql string predicate on the name field.
func (f *ChannelAccountFilter) WhereName(p entql.StringP) {
	f.Where(p.Field(channelaccount.FieldName))
}

// WhereIdentity applies the entql string predicate on the identity field.
func (f *ChannelAccountFilter) WhereIdentity(p entql.StringP) {
	f.Where(p.Field(channelaccount.FieldIdentity))
}
...
// WhereCredentials applies the entql json.RawMessage predicate on the credentials field.
func (f *ChannelAccountFilter) WhereCredentials(p entql.BytesP) {
	f.Where(p.Field(channelaccount.FieldCredentials))
}

// WhereAuthState applies the entql string predicate on the auth_state field.
func (f *ChannelAccountFilter) WhereAuthState(p entql.StringP) {
	f.Where(p.Field(channelaccount.FieldAuthState))
}

// WhereAuthErrorCode applies the entql string predicate on the auth_error_code field.
func (f *ChannelAccountFilter) WhereAuthErrorCode(p entql.StringP) {
	f.Where(p.Field(channelaccount.FieldAuthErrorCode))
}

// WhereEnabled applies the entql bool predicate on the enabled field.
func (f *ChannelAccountFilter) WhereEnabled(p entql.BoolP) {
	f.Where(p.Field(channelaccount.FieldEnabled))
}

// WhereWeight applies the entql int predicate on the weight field.
func (f *ChannelAccountFilter) WhereWeight(p entql.IntP) {
	f.Where(p.Field(channelaccount.FieldWeight))
}

// WhereExpiresAt applies the entql time.Time predicate on the expires_at field.
func (f *ChannelAccountFilter) WhereExpiresAt(p entql.TimeP) {
	f.Where(p.Field(channelaccount.FieldExpiresAt))
}

// WhereLastRefreshAt applies the entql time.Time predicate on the last_refresh_at field.
func (f *ChannelAccountFilter) WhereLastRefreshAt(p entql.TimeP) {
	f.Where(p.Field(channelaccount.FieldLastRefreshAt))
}

// WhereHasChannel applies a predicate to check if query has an edge channel.
func (f *ChannelAccountFilter) WhereHasChannel() {
...
func (f *ChannelAccountFilter) WhereHasChannelWith(preds ...predicate.Channel) {
